...
| State | Meaning |
| --- | --- |
| Constructed | The files exist in the candidate package |
| Statically checked | Named validators accepted specified package properties |
| Installed | A named host reported installation |
